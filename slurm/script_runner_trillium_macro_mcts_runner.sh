...
#SBATCH --output=/scratch/zainab14/tree-llm-reasoning/logs/%x-%j.out 
#SBATCH --error=/scratch/zainab14/tree-llm-reasoning/logs/%x-%j.err  
...
PROJECT_DIR=$SCRATCH_DIR/Marco-o1
